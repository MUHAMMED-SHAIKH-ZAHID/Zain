...
const EditItemsForm = ({ items, products, setItems, onClose }) => {
  const {  editsalescolumn,editsalesindex,loading, error } = useSelector((state) => state?.sales);
  ...
  const formik = useFormik({
    initialValues: {
      product_id: editsalescolumn?.product_id || '',
      quantity: editsalescolumn?.quantity || 1,
      price: editsalescolumn?.price || 0,
      mrp: editsalescolumn?.mrp || 0,
      discount: editsalescolumn?.discount || 0,
      tax: editsalescolumn?.tax || 0,
      total: editsalescolumn?.total || 0,
      tax_amount: editsalescolumn?.tax_amount || 0,
      total_inc_tax: editsalescolumn?.total_inc_tax || 0,
      hsn: editsalescolumn?.hsn || 0,
      ean_code: editsalescolumn?.ean_code || 0,
    },
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="">
      <div className="grid grid-cols-2 gap-4 p-4">
        ...
        <div>
          <label htmlFor="product_id" className="block text-sm pb-2 font-medium text-gray-700">Product:</label>
          <Select
									showSearch
                  size='middle'
                  ...
                  defaultValue={editsalescolumn?.product_id}
