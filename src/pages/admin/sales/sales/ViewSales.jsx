...
const ViewSales = () => {
  ...
  const navigate = useNavigate()
    ...
    console.log(viewsalesdata,"LOOOOOOOOOOOOOOOOOOOOOw")
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center h-full">
        <div className="text-md font-medium mb-4">Loading Invoice data...</div>
        <div className="border-8 border-black border-t-blue-500 rounded-full w-16 h-16 animate-spin"></div>
      </div>
    );
  }  return (
    ...
    <div className="grid grid-cols-3 items-end">
      ...
      <div className="grid grid-cols-[2fr,3fr,1fr] text-[.5rem] md:text-[0.8rem] border-2 border-black border-b-0">
      ...
      <div className="grid grid-cols-2  justify-between">
        ...
        <div className="border-2 border-x-0 border-black flex justify-between">
          <div className="p-1">DATE</div>
          <div className="text-start flex p-1">&nbsp; : &nbsp;{viewsalesdata?.invoice_date}</div>
        </div>
      </div>
    </div>
    <div className="grid grid-cols-[2fr,3fr,1fr] text-[.5rem] md:text-[0.8rem] border-2 border-black ">
  ...
  <table className="min-w-full divide-y mt-3 divide-gray-200 border-black border-2">
      <thead className="">
        <tr>
          <th scope="col" className="px-2 py-1 text-cneter md:text-xs text-[.5rem] font-medium text-gray-500 uppercase tracking-wider border-black border-2 w-1/3">Particulars</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Psc</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Gross Amt</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Sch Amt</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Oth Disc Amt</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Taxable Amt</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Tax Amt</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Net Payable</th>
        </tr>
      </thead>
      {viewsalesdata?.sales_items?.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td className="px-6 text-center whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">CGST {(parseInt(item?.tax)/2).toFixed(2)} + SGST {(parseInt(item?.tax)/2).toFixed(2)  || 0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.quantity}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.price}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">0</td>
                    <td  className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.discount  || 0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.total}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.tax_amount || 0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.total_inc_tax ||0}</td>
...
<td className="px-6 text-center whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">Total</td>

<td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{items?.reduce((acc, item) => parseInt(acc) + parseInt(item.quantity), 0)}</td>
<td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{items?.reduce((acc, item) => parseInt(acc) + parseFloat(item.price), 0).toFixed(2)}</td>
<td  className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">0</td>
<td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{items?.reduce((acc, item) => parseInt(acc) + parseFloat(item.discount), 0).toFixed(2)}</td>
<td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{items?.reduce((acc, item) => parseInt(acc) + parseFloat(item.total), 0).toFixed(2)}</td>
<td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{items?.reduce((acc, item) => parseInt(acc) + parseFloat(item.tax_amount), 0).toFixed(2)}</td>
<td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{items?.reduce((acc, item) => parseInt(acc) + parseFloat(item.total_inc_tax), 0).toFixed(2)}</td>
</tr>
...
<table className="min-w-full divide-y mt-3 divide-gray-200 border-black border-2">
      <thead className="">
        <tr>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Sl No.</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">HSN</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">ITEM Name</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">MRP</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Qty</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Price</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Gross</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Disc</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Taxable</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Gst %</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Gst</th>
          <th scope="col" className="px-2 py-1 text-left md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-2">Net</th>
        </tr>
      </thead>
      {viewsalesdata?.sales_items?.map((item, index) => (
                  <tr key={index}>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{index + 1}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.hsn}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{products?.find(pro => pro.id == item?.product_id)?.product_name || item?.product_id}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.mrp  || 0}</td>
                    <td  className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.qty  || 0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.price}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.total || 0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.discount ||0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.total ||0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.tax ||0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.tax_amount ||0}</td>
                    <td className="px-6 whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2">{item?.total_inc_tax ||0}</td>
    ...
    <div className="grid text-sm gap-2 pt-4 justify-items-center">
            ...
            <div className="grid grid-cols-[5fr,1fr] border-black border-2">
              <div className="grid">
            ...
            <div className="grid grid-cols-[5fr,1fr] border-black border-2 mt-8 text-[.7rem]">
              <div className="grid">
                ...
                <div className="">
                  <div className="grid grid-cols-2 border-black border-2 border-t-0">
      ...
      <thead className="">
        <tr>
          <th scope="col" className="px-2 py-1 text-center md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-t-0 border-l-0 border-2">Invoice Number.</th>
          <th scope="col" className="px-2 py-1 text-center md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-t-0 border-l-0 border-2">Customer Code</th>
          <th scope="col" className="px-2 py-1 text-center md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-t-0 border-l-0 border-2">Invoice Date</th>
          <th scope="col" className="px-2 py-1 text-center md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider border-black border-t-0 border-l-0 border-2">Invoice Amt</th>
          <th scope="col" className="px-2 py-1 text-center md:text-xs text-[.5rem] font-medium text-gray-500  tracking-wider ">Balance</th>
        </tr>
      </thead>
    
                  <tr >
                    <td className="px-6 text-center whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2 border-l-0 border-b-0">{viewsalesdata?.invoice_number} </td>
                    <td className="px-6 text-center whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2 border-l-0 border-b-0">{viewsalesdata?.code}</td>
                    <td className="px-6 text-center whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2 border-l-0 border-b-0">{viewsalesdata?.invoice_date}</td>
                    <td className="px-6 text-center whitespace-nowrap md:text-xs text-[.5rem] text-gray-500 border-black border-2 border-l-0 border-b-0">{viewsalesdata?.grand_total}</td>
