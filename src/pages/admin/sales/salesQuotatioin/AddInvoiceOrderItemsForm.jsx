...
const AddInvoiceOrderItemsForm = ({ items, products, setItems, onClose }) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="">
      <div className="grid grid-cols-2 gap-4 p-4">
        ...
        <div>
          <label htmlFor="product_id" className="block mb-1 text-sm font-medium text-gray-700">Product:</label>
          <Select
									showSearch
                  size='middle'
...
export default AddInvoiceOrderItemsForm;
