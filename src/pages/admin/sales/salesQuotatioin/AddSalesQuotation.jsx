...
const AddSalesQuotation = () => {
  ...
  const navigate = useNavigate()
    const { customers,products, loading, error } = useSelector((state) => state?.salesQuotation);
     console.log(customers,"customers list",products);
...
useEffect(() => {
  dispatch(setHeading("Supplier Quote"));
  ...
  return (
    <div className="  p-5">
      <h2 className="text-xl font-bold mb-5 text-center">Create Sales Quote</h2>
