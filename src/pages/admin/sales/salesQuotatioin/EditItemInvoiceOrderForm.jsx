...
const EditItemInvoiceOrderForm = ({ items,products, setItems, onClose }) => {
  const {  editpurchasecolumn, editpurchaseindex, loading, error } = useSelector((state) => state?.purchases);
  ...
  useEffect(() => {
    ...
    if (selectedProduct) {
      ...
      setSeletedPrice(selectedProduct.price)
      ...
      <div className="grid grid-cols-2 gap-4 p-4">
        ...
        <div>
          ...
          <Select
                  ...
                  defaultValue={products.find(item => item.id == editpurchasecolumn?.product_id)?.product_name}
...
export default EditItemInvoiceOrderForm;
