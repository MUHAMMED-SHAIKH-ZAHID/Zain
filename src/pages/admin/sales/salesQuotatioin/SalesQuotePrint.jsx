  ...
  return (
    <div className="  mx-6 m-5 border drop-shadow-sm">
      ...
      <div className="">+91 9999999999</div>
            ...
            <div className="text-md font-semibold">{viewSales?.supplier?.name}</div>
            <div className="">{viewSales?.supplier?.address_one}</div>
            <div className="">{viewSales?.supplier?.contact_one}</div>
            <div className="">{viewSales?.supplier?.gst_number}</div>
            </div>
            </div>
            <div className="">
...
export default SalesQuotePrint;
