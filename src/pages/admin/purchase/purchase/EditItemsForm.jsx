...
const EditItemsForm = ({ items, setItems, onClose }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      quantity: editpurchasecolumn?.quantity,
      inbound: 0,
      outbound: 0,
      price: editpurchasecolumn?.price,
      tax: editpurchasecolumn?.tax,
      total: editpurchasecolumn?.total,
      tax_amount: editpurchasecolumn?.tax_amount,
      total_inc_tax: editpurchasecolumn?.total_inc_tax,
      id:editpurchasecolumn?.id,
    },
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="space-y-4 p-4">
      ...
      <div>
        <label htmlFor="inbound" className="block text-sm font-medium text-gray-700">Physical:</label>
        <input
          id="inbound"
          type="number"
      ...
      <div>
        <label htmlFor="outbound" className="block text-sm font-medium text-gray-700">Transist:</label>
        <input
          id="outbound"
          type="number"
