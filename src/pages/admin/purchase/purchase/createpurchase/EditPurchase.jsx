 ...
 const [items, setItems] = useState(editpurchase?.purchase_items);
    ...
    const formik = useFormik({
      initialValues: {
        ...
        discount: editpurchase?.discount || 0,
        payment_mode: editpurchase?.payment_mode,
        account_id: editpurchase?.account_id,
        reference_number: editpurchase?.reference_number,
        reference_date: editpurchase?.reference_date,
...
const importPurchaseOrder = () =>{
  ...
  return (
    ...
    <h2 className="text-xl font-medium mb-5 text-center">Edit Purchase Bill </h2>
