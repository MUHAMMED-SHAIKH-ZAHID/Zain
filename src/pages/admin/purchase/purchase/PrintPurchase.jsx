...
const PrintPurchase = () => {
  ...
  const navigate = useNavigate()
    // const { suppliers,PrintPurchase,products, loading, error } = useSelector((state) => state?.purchaseQuotation);
    const { suppliers,viewpurchasedata,products, loading, error } = useSelector((state) => state?.purchases);
    ...
    const formik = useFormik({
        initialValues: {
            ...
            transaction_mode:viewpurchasedata?.transaction_mode,
        },
...
useEffect(() => {
  ...
  <div className="grid grid-cols-2 w-full p-5">
           ...
           <div className="">
            ...
            <div className="text-md font-semibold">{viewpurchasedata?.supplier?.name}John smith</div>
            <div className="">{viewpurchasedata?.supplier?.address_one}las vegas</div>
            <div className="">{viewpurchasedata?.supplier?.contact_one}+92 839 4328</div>
            <div className="">{viewpurchasedata?.supplier?.gst_number}834945 48499 </div>
            </div>
            </div>
