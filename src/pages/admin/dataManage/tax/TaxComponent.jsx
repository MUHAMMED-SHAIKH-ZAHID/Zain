...
const TaxComponent = () => {
    ...
    console.log(taxes,"touteo poage route")
    useEffect(() => {
      dispatch(fetchTaxes());
    }, [dispatch]);
    ...
    const handleDelete = () => {
        dispatch(deleteTax(routeToDelete.id));
        setDeleteModalVisible(false);
    };

    const handleSubmit = (data) => {
        if (currentRoute) {
            dispatch(updateTax({ id: currentRoute.id, ...data }));
        } else {
    ...
    return (
      ...
      <div className="">
        ...
        <Modal
          ...
          content={<TaxForm initialData={currentRoute} onSubmit={handleSubmit} onCancel={handleClose} />}
        />
        <Modal
