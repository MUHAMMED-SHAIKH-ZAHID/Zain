...
import { deleteBrand, fetchBrands } from '../../../../redux/features/DataManageSlices/BrandSlice';
    ...
    <div className="container mx-auto px-4 sm:px-8">
                  ...
                  <tr key={brand.id}>
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <div className="flex items-center">
                        <div className="ml-3">
                          <p className="text-gray-900 whitespace-no-wrap">{brand.name}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <p className="text-gray-900 whitespace-no-wrap">{brand.description}</p>
                    </td>
      ...
      {showModal && (
        <Modal
          ...
          content={<BrandForm initialData={currentBrand} onSubmit={closeModal} onCancel={closeModal} />}
        />
      )}
    </div>
  );
