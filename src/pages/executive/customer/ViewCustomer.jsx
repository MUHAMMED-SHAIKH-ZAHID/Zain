...
const ViewCustomer = () => {
    const { currentCustomer ,loading} = useSelector((state) => state?.customerexecutive);
            ...
            <div className="bg-white shadow-xl rounded-lg overflow-hidden flex flex-col md:flex-row">
                <div className="md:w-1/3 bg-gray-200 p-4 flex flex-col items-center">
                    <img
                        ...
                        width="120"
                    />
                    <p className="text-gray-600 text-lg font-medium">{currentCustomer?.company_name}</p>
                    <h1 className="text-gray-800 mt-1">{currentCustomer?.name}</h1>
                    <div className="grid grid-cols-1 gap-2 text-gray-500 mt-1">
                        ...
                        {/* <div className="flex items-center">
                            ...
                            <span className="ml-3">{currentCustomer?.pan}</span>
                        </div> */}
                    </div>
                </div>
