...
import { createSalesQuotation } from '../../../redux/features/salesExecutive/ExecutiveSalesQuotationSlice';
...
const AddSalesQuotation = () => {
  ...
  const { customers,products, loading, error } = useSelector((state) => state?.executiveSalesOrder);
        ...
        .then((res) => {
          if (res.payload.success) {
            toast.success(res.payload.success);
              navigate('/executive/invoice/order');
  ...
  return (
    <div className="px-6 p-4 bg-white">
      <h2 className="text-xl font-medium mb-5 text-center">Create Invoice Order</h2>
