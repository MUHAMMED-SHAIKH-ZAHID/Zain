...
import ExecutiveSideBar from '../components/commoncomponents/ExecutiveSideBar';

const ExecutiveLayout = () => {
  return (
    <div className="h-screen flex bg-black">
      <ExecutiveSideBar className="transition-all duration-300" /> {/* Sidebar with transition for resizing */}
